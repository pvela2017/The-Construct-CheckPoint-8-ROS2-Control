...
{
ElevatorController::ElevatorController() : controller_interface::ControllerInterface() {}
    
// All the methods added must be inside this namespace

CallbackReturn ElevatorController::on_init() {
  try 
  {
...
CallbackReturn ElevatorController::on_configure(const rclcpp_lifecycle::State & /*previous_state*/) 
{
...
controller_interface::InterfaceConfiguration ElevatorController::command_interface_configuration()
  const
{
...
controller_interface::InterfaceConfiguration ElevatorController::state_interface_configuration() const
{
...
template <typename T> bool get_ordered_interfaces(std::vector<T> & unordered_interfaces, 
...
CallbackReturn ElevatorController::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn ElevatorController::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::return_type
ElevatorController::update(const rclcpp::Time &time,
...
PLUGINLIB_EXPORT_CLASS(elevator_controller::ElevatorController, controller_interface::ControllerInterface)